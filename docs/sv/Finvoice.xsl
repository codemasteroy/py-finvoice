...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<!-- Tekstit alkavat -->
	<xsl:variable name="txtINVOICE">FAKTURA</xsl:variable>
	<xsl:variable name="txtCREDITNOTE">KREDITNOTA</xsl:variable>
	<xsl:variable name="txtCOPY">KOPIA</xsl:variable>
	<xsl:variable name="txtSeller">Säljare</xsl:variable>
	<xsl:variable name="txtTaxCode">FO-nummer</xsl:variable>
	<xsl:variable name="txtBuyerOrganisationName">Köpare</xsl:variable>
	<xsl:variable name="txtInvoiceRecipientContact">Fakturamottagarens kontaktuppgifter</xsl:variable>
	<xsl:variable name="txtInvoiceDate">Fakturadatum</xsl:variable>
	<xsl:variable name="txtInvoiceNumber">Fakturanummer</xsl:variable>
	<xsl:variable name="txtSellerReferenceIdentifier">Säljarens referens</xsl:variable>
	<xsl:variable name="txtOrderIdentifier">Beställning / avtal</xsl:variable>
	<xsl:variable name="txtAgreement">Avtal</xsl:variable>
	<xsl:variable name="txtAgreementDate">Avtaldatum</xsl:variable>
	<xsl:variable name="txtBuyerPartyIdentifier">Köparens kod</xsl:variable>
	<xsl:variable name="txtInvoiceDueDate">Förfallodag</xsl:variable>
	<xsl:variable name="txtEpiInstructedAmount">Belopp</xsl:variable>
	<xsl:variable name="txtEpiAccountID">Betalningsmottagarens bankkonto</xsl:variable>
	<xsl:variable name="txtEpiNameAddressDetails">Betalningsmottagarens namn</xsl:variable>
	<xsl:variable name="txtEpiRemittanceInfoIdentifier">Referensnummer</xsl:variable>
	<xsl:variable name="txtPaymentStatusCode">Betalningsläge</xsl:variable>
	<xsl:variable name="txtPaymentMethodText">Betalningssätt</xsl:variable>
	<xsl:variable name="txtPaymentTermsFreeText">Betalningsvillkor</xsl:variable>
	<xsl:variable name="txtPaymentOverDueFineDetails">Dröjsmålsuppgifter</xsl:variable>
	<xsl:variable name="txtPaymentOverDueFinePercent">Dröjsmålsränta</xsl:variable>
	<xsl:variable name="txtDeliveryParty">Leveransadress</xsl:variable>
	<xsl:variable name="txtDeliveryDate">Leveransdag</xsl:variable>
	<xsl:variable name="txtDeliveryPeriodDetails">Leveransperiod</xsl:variable>
	<xsl:variable name="txtDeliveryMethod">Leveranssätt</xsl:variable>
	<xsl:variable name="txtDeliveryTerms">Leveransvillkor</xsl:variable>
	<xsl:variable name="txtTerminalAddress">Terminaladress</xsl:variable>
	<xsl:variable name="txtWaybillIdentifier">Fraktsedelns referens</xsl:variable>
	<xsl:variable name="txtWaybillMaker">Fraktsedeln uppgjord av</xsl:variable>
	<xsl:variable name="txtPaymentStatusNotPaid">Utestående</xsl:variable>
	<xsl:variable name="txtPaymentStatusPartlyPaid">Delvis betald</xsl:variable>
	<xsl:variable name="txtPaymentStatusPaid">Betald</xsl:variable>
	<xsl:variable name="txtArticleName">Produkt/service</xsl:variable>
	<xsl:variable name="txtRowIdentifier">Beställningsreferens</xsl:variable>
	<xsl:variable name="txtRowIdentifierDate">Beställningsdag</xsl:variable>
	<xsl:variable name="txtArticleIdentifier">Produktkod</xsl:variable>
	<xsl:variable name="txtBuyerArticleIdentifier">Köparens produktkod</xsl:variable>
	<xsl:variable name="txtRowQuotationIdentifier">Offertreferens</xsl:variable>
	<xsl:variable name="txtDeliveredQuantity">Levererat antal</xsl:variable>
	<xsl:variable name="txtOrderedQuantity">Beställt antal</xsl:variable>
	<xsl:variable name="txtConfirmedQuantity">Bekräftat antal</xsl:variable>
	<xsl:variable name="txtUnitPriceAmount">Enhetspris utan moms</xsl:variable>
	<xsl:variable name="txtUnitPriceVatIncludedAmount">Enhetspris inkl. moms</xsl:variable>
	<xsl:variable name="txtRowDeliveryDates">Leveransdag (levererat)</xsl:variable>
	<xsl:variable name="txtRowDeliveryIdentifier">Leveransreferens</xsl:variable>
	<xsl:variable name="txtRowDiscount">Rabatt</xsl:variable>
	<xsl:variable name="txtVat">Moms</xsl:variable>
	<xsl:variable name="txtVatAmount">Momsbelopp</xsl:variable>
	<xsl:variable name="txtVatExcludedAmount">Belopp utan moms</xsl:variable>
	<xsl:variable name="txtRowAmount">Totalt</xsl:variable>
	<xsl:variable name="txtINVOICETOTAL">FAKTURA TOTALT</xsl:variable>
	<xsl:variable name="txtVatSpecification">Momsspecifikation</xsl:variable>
	<xsl:variable name="txtShortProposedAccountIdentifier">Konteringsförslag (kort)</xsl:variable>
	<xsl:variable name="txtNormalProposedAccountIdentifier">Konteringsförslag (normalt)</xsl:variable>
	<xsl:variable name="txtAccountDimension">Kostnadsställe</xsl:variable>
	<xsl:variable name="txtVirtualBankBarcode">Virtuell streckkod</xsl:variable>
	<xsl:variable name="txtPartialPaymentDetails">Delbetalningsuppgifter</xsl:variable>
	<xsl:variable name="txtPaidAmount">Betalt belopp</xsl:variable>
	<xsl:variable name="txtUnPaidAmount">Obetalt belopp</xsl:variable>
	<xsl:variable name="txtInterestPercent">Räntefot</xsl:variable>
	<xsl:variable name="txtProsessingCostsAmount">Expeditionsavgift</xsl:variable>
	<xsl:variable name="txtPartialPaymentDueDate">Delbetalningens förfallodag</xsl:variable>
	<xsl:variable name="txtVatIncludedAmount">Belopp inkl. moms</xsl:variable>
	<xsl:variable name="txtPartialPaymentReferenceIdentifier">Delbetalningens referens</xsl:variable>
	<xsl:variable name="txtPhoneNumber">Tel.</xsl:variable>
	<xsl:variable name="txtFaxNumber">Fax</xsl:variable>
	<xsl:variable name="txtWebaddressIdentifier">www-adress</xsl:variable>
	<xsl:variable name="txtEmailaddressIdentifier">E-post</xsl:variable>
	<xsl:variable name="txtHomeTownName">Hemort</xsl:variable>
	<xsl:variable name="txtEur">euro</xsl:variable>
	<xsl:variable name="txtLink">Länk</xsl:variable>
	<xsl:variable name="txtAgreementIdentifier">Avtalsreferens</xsl:variable>
	<xsl:variable name="txtProposedAccountIdentifier">Konteringsförslag</xsl:variable>
	<xsl:variable name="txtEpiBfiIdentifier">Bankens BIC-kod</xsl:variable>
	<xsl:variable name="txtDeliverer">Leverantör</xsl:variable>
	<xsl:variable name="txtManufacturer">Tillverkare</xsl:variable>
	<xsl:variable name="txtInvoiceRecipientAddress">Faktureringsadress</xsl:variable>
	<xsl:variable name="txtCashDiscountDate">Kassarabattdatum</xsl:variable>
	<xsl:variable name="txtCashDiscountPercent">Kassarabattprocent</xsl:variable>
	<xsl:variable name="txtCashDiscountAmount">Kassarabattbelopp</xsl:variable>
	<xsl:variable name="txtInvoiceSender">Fakturans avsändare</xsl:variable>
	<xsl:variable name="txtOriginalInvoice">Originalfakturans nummer</xsl:variable>
	<xsl:variable name="txtPriceListIdentifier">Prislistans referens</xsl:variable>
	<xsl:variable name="txtRequestOfQuotationIdentifier">Referens för offertbegäran</xsl:variable>
	<xsl:variable name="txtDeliveryInfo">Leveransvillkor</xsl:variable>
	<xsl:variable name="txtInvoicingPeriod">Faktureringsperiod</xsl:variable>
	<xsl:variable name="txtOrdererName">Beställarens namn</xsl:variable>
	<xsl:variable name="txtAgreementType">Avtalstyp</xsl:variable>
	<xsl:variable name="txtBuyersSellerId">Köparens referens för säljaren</xsl:variable>
	<xsl:variable name="txtSellersBuyerId">Kundnummer</xsl:variable>
	<xsl:variable name="txtBuyerReference">Köparens referens </xsl:variable>
	<xsl:variable name="txtNotificationId">Meddelandets kod</xsl:variable>
	<xsl:variable name="txtNotificationDate">Meddelandets datering</xsl:variable>
	<xsl:variable name="txtRegNumberId">Registreringskod</xsl:variable>
	<xsl:variable name="txtProjectRefId">Projektets kod</xsl:variable>
	<xsl:variable name="txtCreditLimit">Kreditlimit</xsl:variable>
	<xsl:variable name="txtCreditInterest">Kreditränta</xsl:variable>
	<xsl:variable name="txtOperationLimit">Kreditens övre gräns</xsl:variable>
	<xsl:variable name="txtCashDiscountExlVat">Kassarabatt utan moms</xsl:variable>
	<xsl:variable name="txtCashDiscountVat">Kassarabattens moms</xsl:variable>
	<xsl:variable name="txtFactoringPartyName">Finansbolagets namn</xsl:variable>
	<xsl:variable name="txtFactoringPartyId">Finansbolagets kod</xsl:variable>
	<xsl:variable name="txtFactoringFreeText">Överföringsklausul</xsl:variable>
	<xsl:variable name="txtSalesPersonName">Säljarens namn</xsl:variable>
	<xsl:variable name="txtAnyPartyIdentifier">Kod</xsl:variable>
	<xsl:variable name="txtAnyPartyOrgName">Namn</xsl:variable>
	<xsl:variable name="txtAnyPartyOrgDep">Avdelning</xsl:variable>
	<xsl:variable name="txtAnyPartyOrgUnit">Organisationsenhet</xsl:variable>
	<xsl:variable name="txtSiteCode">Partens kod</xsl:variable>
	<xsl:variable name="txtAddress">Adress</xsl:variable>
	<xsl:variable name="txtAveragePrice">Medelpris</xsl:variable>
	<xsl:variable name="txtArticleGroupIdentifier">Produktgrupp</xsl:variable>
	<xsl:variable name="txtEanCode">EAN-kod</xsl:variable>
	<xsl:variable name="txtRegistrationNumberId">Registerkod</xsl:variable>
	<xsl:variable name="txtSerialNumberId">Serienummer</xsl:variable>
	<xsl:variable name="txtRowActionCode">Uppgiftskod</xsl:variable>
	<xsl:variable name="txtClearanceId">Förtullningsreferens</xsl:variable>
	<xsl:variable name="txtDeliveryNoteId">Godslistans kod</xsl:variable>
	<xsl:variable name="txtPlaceOfDischarge">Avlämningsplats</xsl:variable>
	<xsl:variable name="txtFinalDestination">Destination</xsl:variable>
	<xsl:variable name="txtManufacturerArticleId">Tillverkarens produktkod</xsl:variable>
	<xsl:variable name="txtManufacturerOrderId">Tillverkarens produktreferens</xsl:variable>
	<xsl:variable name="txtPackageLength">Förpackningens längd</xsl:variable>
	<xsl:variable name="txtPackageWidth">Förpackningens bredd</xsl:variable>
	<xsl:variable name="txtPackageHeight">Förpackningens höjd</xsl:variable>
	<xsl:variable name="txtPackageWeight">Förpackningens vikt</xsl:variable>
	<xsl:variable name="txtPackageNetWeight">Nettovikt</xsl:variable>
	<xsl:variable name="txtPackageVolume">Förpackningens volym</xsl:variable>
	<xsl:variable name="txtTransportCarriageQuantity">Antalet transportflak</xsl:variable>
	<xsl:variable name="txtDiscounts">Rabatter</xsl:variable>
	<xsl:variable name="txtInvoiceRow">Fakturarad</xsl:variable>
	<xsl:variable name="txtRounding">Avrundning</xsl:variable>
	<xsl:variable name="txtExchangeRate">Kurs</xsl:variable>
	<xsl:variable name="txtOtherCurrency">Ursprungligt antal</xsl:variable>
	<xsl:variable name="txtShipmentOrg">Leverantör</xsl:variable>
	<xsl:variable name="txtReducedAmount">Rabatterat belopp</xsl:variable>
	<xsl:variable name="txtOfferedQuantity">Offererad mängd</xsl:variable>
	<xsl:variable name="txtPostDeliveredQuantity">I efterskott levererad mängd</xsl:variable>
	<xsl:variable name="txtInvoicedQuantity">Fakturerad mängd</xsl:variable>
	<xsl:variable name="txtRowUsedQuantity">Förbrukad mängd</xsl:variable>
	<xsl:variable name="txtRowPreviousMeterReadingDate">Föregående mätaravläsningsdag</xsl:variable>
	<xsl:variable name="txtRowLatestMeterReadingDate">Sista mätaravläsningsdag</xsl:variable>
	<xsl:variable name="txtRowCalculatedQuantity">Beräknad mängd</xsl:variable>
	<xsl:variable name="txtOriginalInvoiceIdentifier">Originalfakturans nummer</xsl:variable>
	<xsl:variable name="txtOriginalInvoiceDate">Originalfakturans datering</xsl:variable>
	<xsl:variable name="txtOriginalDueDate">Ursprunglig förfallodag</xsl:variable>
	<xsl:variable name="txtOriginalInvoiceTotalAmount">Ursprungligt belopp</xsl:variable>
	<xsl:variable name="txtOriginalEpiRemittanceInfoIdentifier">Originalfakturans referens</xsl:variable>
	<xsl:variable name="txtPaidDate">Betalningsdatum</xsl:variable>
	<xsl:variable name="txtCollectionDate">Indrivningsdag</xsl:variable>
	<xsl:variable name="txtCollectionQuantity">Antal indrivningar</xsl:variable>
	<xsl:variable name="txtCollectionChargeAmount">Indrivningskostnader</xsl:variable>
	<xsl:variable name="txtInterestRate">Straffränta</xsl:variable>
	<xsl:variable name="txtInterestStartDate">Första räntedag</xsl:variable>
	<xsl:variable name="txtInterestEndDate">Sista räntedag</xsl:variable>
	<xsl:variable name="txtInterestPeriodText">Ränteperiod</xsl:variable>
	<xsl:variable name="txtInterestDateNumber">Antal räntedagar</xsl:variable>
	<xsl:variable name="txtInterestChargeAmount">Räntebelopp</xsl:variable>
	<xsl:variable name="txtInterestChargeVatAmount">Räntemoms</xsl:variable>
	<xsl:variable name="txtControllerIdentifier">Kontrollörens kod</xsl:variable>
	<xsl:variable name="txtControllerName">Kontrollörens namn</xsl:variable>
	<xsl:variable name="txtControlDate">Kontrolldatum</xsl:variable>
	<xsl:variable name="txtContact">Kontaktuppgifter</xsl:variable>
	<xsl:variable name="txtFreeText">Meddelanden</xsl:variable>
	<xsl:variable name="txtVatCode_AB">Marginalskatt</xsl:variable>
	<xsl:variable name="txtVatCode_AE">Omvänd Moms</xsl:variable>
	<xsl:variable name="txtVatCode_E">Gemenskaps försäljning</xsl:variable>
	<xsl:variable name="txtVatCode_G">Skattefri försäljning till utlandet (tredje land)</xsl:variable>
	<xsl:variable name="txtVatCode_O">Skattefri product</xsl:variable>
	<xsl:variable name="txtVatCode_S">Normal skatteprocent</xsl:variable>
	<xsl:variable name="txtVatCode_Z">Skattefri produkt</xsl:variable>
	<xsl:variable name="txtVatCode_ZEG">Skatte på köp av varor från andra EU-länder</xsl:variable>
	<xsl:variable name="txtVatCode_ZES">Skatte på köp av tjänster  från andra EU-länder</xsl:variable>
	<!-- Tekstit loppuivat -->
