...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<xsl:variable name="txtTimeStamp">Tidstämpel</xsl:variable>
	<xsl:variable name="txtMessageTypeCode">Typkod</xsl:variable>
	<xsl:variable name="txtMessageTypeText">Meddelandetyp</xsl:variable>
	<xsl:variable name="txtActionCode">Åtgärd</xsl:variable>
	<xsl:variable name="txtADD">Tillägg</xsl:variable>
	<xsl:variable name="txtCHANGE">Ändring</xsl:variable>
	...
	<xsl:variable name="txtInvoiceSender">Fakturautställarens uppgifter</xsl:variable>
	<xsl:variable name="txtInvoiceSenderAddress">Sändningsadress</xsl:variable>
	<xsl:variable name="txtInvoiceSenderIntermediatorAddress">Förmedlarens kod</xsl:variable>
	...
	<xsl:variable name="txtPaymentInstructionIdentifier">Kod för faktureringsgrund</xsl:variable>
	...
	<xsl:variable name="txtProposedDueDate">Föreslagen förfallodag</xsl:variable>
	<xsl:variable name="txtProposedInvoicePeriod">Föreslagen faktureringsperiod</xsl:variable>
	<xsl:variable name="txtProposedInvoicePeriodInfo">(gånger per år)</xsl:variable>
	...
	<xsl:variable name="txtSellerAccountDetails">Fakturerarens bankförbindelse</xsl:variable>
	...
	<xsl:variable name="txtBuyerPartyDetails">Köparens uppgifter</xsl:variable>
	...
	<xsl:variable name="txtInvoiceRecipientIntermediatorAddress">Förmedlarens kod</xsl:variable>
	...
	<xsl:variable name="txtIdMaintenance">underhåll</xsl:variable>
	<xsl:variable name="txtLanguage">Språk</xsl:variable>
	...
	<xsl:variable name="txtBuyerServiceCode">Tjänst</xsl:variable>
